...
## Резюме
Данный таймер я делал для себя, поэтому все в нем реализовано именно так, как мне удобно. В нем нет "ползунка", так как на мой взгляд ~~это свистоперделка~~ удобнее задавать время числами, и по сути это лишний компонент. В числе преимуществ моего решения по сравнению с другими можно выделить: возможность 
## Инструкция
### Установка
...
## Отдельное спасибо
Tom Tomich
Если вам понравился таймер, поставьте звездочку! Также вы можете сделать [донат]()
