...
В нем нет "ползунка", как в вариации Том Томыча, так как на мой взгляд ~~это свистоперделка~~ удобнее задавать время числами, и по сути это лишний компонент. Также была уменьшена частота мигания подсветкой во время ожидания
## Инструкция
### Установка
